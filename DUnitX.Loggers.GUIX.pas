...
type
  TDesktopGUITestRunner = class(TForm, ITestLogger)
    TopPanel: TPanel;
...
var
  DesktopGUITestRunner: TDesktopGUITestRunner;
...
procedure TDesktopGUITestRunner.BuildEnabledTestList;
...
procedure TDesktopGUITestRunner.BuildTree(parentNode: TTreeViewItem;
...
procedure TDesktopGUITestRunner.SaveConfiguration(AIniFile: TCustomIniFile);
const
  DisabledTests = 'DisabledTests';
...
procedure TDesktopGUITestRunner.SelectFailedButtonClick(Sender: TObject);
...
function TDesktopGUITestRunner.CreateNode(Owner: TComponent; Test: ITest): TTreeViewItem;
begin
  Result := TTestNode.Create(Owner, Test, Test.Name, Test.Fixture.FullName + '.' + Test.Name);
end;

function TDesktopGUITestRunner.CreateNode(Owner: TComponent; Text: String; TestFullName: String): TTreeViewItem;
begin
  Result := TTestNode.Create(Owner, nil, Text, TestFullName);
end;

procedure TDesktopGUITestRunner.FailListItemClick(const Sender: TObject;
  const AItem: TListViewItem);
var
...
procedure TDesktopGUITestRunner.FormClose(Sender: TObject; var Action: TCloseAction);
var
  LIniFile: TCustomIniFile;
begin
  LIniFile := TMemIniFile.Create(ExtractFilePath(ParamStr(0)) + TEST_INI_FILE);
...
procedure TDesktopGUITestRunner.FormCreate(Sender: TObject);
begin
...
procedure TDesktopGUITestRunner.FormDestroy(Sender: TObject);
begin
  FFailedTests.Free;
  FLastResult := nil;
  FFixtureList := nil;
...
procedure TDesktopGUITestRunner.FormShow(Sender: TObject);
begin
...
function TDesktopGUITestRunner.GetNode(FullName: String): TTreeViewItem;
var
  i: Integer;
begin
  Result := nil;
...
procedure TDesktopGUITestRunner.OnBeginTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnEndSetupFixture(const threadId: TThreadID;
  const fixture: ITestFixtureInfo);
begin

end;

procedure TDesktopGUITestRunner.OnEndSetupTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnEndTearDownFixture(const threadId: TThreadID;
  const fixture: ITestFixtureInfo);
begin

end;

procedure TDesktopGUITestRunner.OnEndTeardownTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnEndTest(const threadId: TThreadID;
...
procedure TDesktopGUITestRunner.OnEndTestFixture(const threadId: TThreadID;
...
procedure TDesktopGUITestRunner.OnExecuteTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnLog(const logType: TLogLevel; const msg: string);
begin

end;

procedure TDesktopGUITestRunner.OnSetupFixture(const threadId: TThreadID;
  const fixture: ITestFixtureInfo);
begin

end;

procedure TDesktopGUITestRunner.OnSetupTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnStartTestFixture(const threadId: TThreadID;
  const fixture: ITestFixtureInfo);
begin

end;

procedure TDesktopGUITestRunner.OnTearDownFixture(const threadId: TThreadID;
  const fixture: ITestFixtureInfo);
begin

end;

procedure TDesktopGUITestRunner.OnTeardownTest(const threadId: TThreadID;
  const Test: ITestInfo);
begin

end;

procedure TDesktopGUITestRunner.OnTestError(const threadId: TThreadID;
  const Error: ITestError);
begin

end;

procedure TDesktopGUITestRunner.OnTestFailure(const threadId: TThreadID;
  const Failure: ITestError);
begin

end;

procedure TDesktopGUITestRunner.OnTestIgnored(const threadId: TThreadID;
  const Ignored: ITestResult);
begin

end;

procedure TDesktopGUITestRunner.OnTestingEnds(const RunResults: IRunResults);
begin

end;

procedure TDesktopGUITestRunner.OnTestingStarts(const threadId: TThreadID; testCount,
  testActiveCount: Cardinal);
begin

end;

procedure TDesktopGUITestRunner.OnTestMemoryLeak(const threadId: TThreadID;
  const AIgnored: ITestResult);
begin

end;

procedure TDesktopGUITestRunner.OnTestSuccess(const threadId: TThreadID;
  const Test: ITestResult);
begin

end;

procedure TDesktopGUITestRunner.RunExecute(Sender: TObject);
begin
...
procedure TDesktopGUITestRunner.TestTreeChangeCheck(Sender: TObject);
var
  I: Integer;
begin
